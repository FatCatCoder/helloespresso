    ...
    return(
        <div className="container col-10 col-xl-6 mx-auto text-center d-block">
            ...
            <div className="btn-group col-10 col-sm-8 col-md-4 col-lg-4 col-xl-4 text-center flex-wrap mx-auto d-flex justify-content-center" role="group" aria-label="Basic radio toggle button group">
                ...
                <label className="btn btn-outline-primary" htmlFor="btnradio1">Sour</label>
                ...
                <label className="btn btn-outline-primary" htmlFor="btnradio2">Bitter / Ashy</label>
                ...
                <label className="btn btn-outline-primary" htmlFor="btnradio3">Bland / Weak</label>
                ...
                <label className="btn btn-outline-primary" htmlFor="btnradio4">Balanced</label>
                ...
                <label className="btn btn-outline-primary" htmlFor="btnradio5">Missing?</label>
