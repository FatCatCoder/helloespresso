     ...
     <div className="container h-100 text-center">
      ...
      <Fade cascade when={showSecret}>
        <div className="container col-12 col-md-8">
          ...
          <p>I want to hear from you. Send any requests for new features or bug fixes to one of my handles <span className="row"><strong><i className="bi bi-envelope-fill"></i> helloespresso.coffee@gmail.com</strong> <a href="https://twitter.com/hello__espresso"><i className="bi bi-twitter"></i> @hello__espresso</a></span> <a href="https://github.com/fatcatcoder"><i className="bi bi-github"></i> @FatCatCoder</a></p>
